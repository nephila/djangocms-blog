...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogCategoryTranslation.slug'
        db.alter_column(u'djangocms_blog_blogcategory_translation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BlogCategoryTranslation.slug'
        db.alter_column(u'djangocms_blog_blogcategory_translation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
