...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostTranslation.og_description'
        db.add_column(u'djangocms_blog_post_translation', 'og_description',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'PostTranslation.twitter_description'
        db.add_column(u'djangocms_blog_post_translation', 'twitter_description',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PostTranslation.gplus_description'
        db.add_column(u'djangocms_blog_post_translation', 'gplus_description',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostTranslation.og_description'
        db.delete_column(u'djangocms_blog_post_translation', 'og_description')

        # Deleting field 'PostTranslation.twitter_description'
        db.delete_column(u'djangocms_blog_post_translation', 'twitter_description')

        # Deleting field 'PostTranslation.gplus_description'
        db.delete_column(u'djangocms_blog_post_translation', 'gplus_description')
    ...
    models = {
        ...
        u'djangocms_blog.posttranslation': {
            ...
            'gplus_description': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            ...
            'og_description': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'post_text': ('djangocms_text_ckeditor.fields.HTMLField', [], {'default': "u''", 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'twitter_description': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'blank': 'True'})
        },
        u'filer.file': {
