...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostTranslation.slug'
        db.alter_column(u'djangocms_blog_post_translation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PostTranslation.slug'
        db.alter_column(u'djangocms_blog_post_translation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
