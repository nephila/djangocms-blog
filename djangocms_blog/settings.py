...
def get_setting(name):
    ...
    default = {
        ...
        "BLOG_FB_PROFILE_ID": getattr(
            settings, "BLOG_FB_PROFILE_ID", meta_settings.FB_PROFILE_ID
        ),
        "BLOG_FB_PUBLISHER": getattr(
            settings, "BLOG_FB_PUBLISHER", meta_settings.FB_PUBLISHER
        ),
        ...
        "BLOG_TWITTER_TYPES": getattr(
            settings, "BLOG_TWITTER_TYPES", meta_settings.TWITTER_TYPES
        ),
        "BLOG_TWITTER_SITE": getattr(
            settings, "BLOG_TWITTER_SITE", meta_settings.TWITTER_SITE
        ),
        "BLOG_TWITTER_AUTHOR": getattr(
            settings, "BLOG_TWITTER_AUTHOR", "get_author_twitter"
        ),
        "BLOG_GPLUS_TYPE": getattr(settings, "BLOG_GPLUS_TYPE", "Blog"),
        "BLOG_GPLUS_TYPES": getattr(
            settings, "BLOG_GPLUS_TYPES", meta_settings.GPLUS_TYPES
        ),
        ...
        "BLOG_PERMALINK_URLS": getattr(
            settings, "BLOG_PERMALINK_URLS", PERMALINKS_URLS
        ),
        "BLOG_DEFAULT_OBJECT_NAME": getattr(
            settings, "BLOG_DEFAULT_OBJECT_NAME", "Article"
        ),
        ...
        "BLOG_SITEMAP_PRIORITY_DEFAULT": getattr(
            settings, "BLOG_SITEMAP_PRIORITY_DEFAULT", "0.5"
        ),
        ...
        "BLOG_PLUGIN_MODULE_NAME": getattr(
            settings, "BLOG_PLUGIN_MODULE_NAME", _("Blog")
        ),
        ...
        "BLOG_LATEST_ENTRIES_PLUGIN_NAME_CACHED": getattr(
            settings,
            "BLOG_LATEST_ENTRIES_PLUGIN_NAME_CACHED",
            _("Latest Blog Articles - Cache"),
        ),
        ...
        "BLOG_FEED_CATEGORY_ITEMS": getattr(settings, "BLOG_FEED_CATEGORY_ITEMS", 10),
