...
class Migration(migrations.Migration):
    ...
    replaces = [('djangocms_blog', '0001_initial'), ('djangocms_blog', '0002_post_sites'), ('djangocms_blog', '0003_auto_20141201_2252'), ('djangocms_blog', '0004_auto_20150108_1435'), ('djangocms_blog', '0005_auto_20150212_1118'), ('djangocms_blog', '0006_auto_20150214_1907'), ('djangocms_blog', '0007_auto_20150719_0933'), ('djangocms_blog', '0008_auto_20150814_0831'), ('djangocms_blog', '0009_latestpostsplugin_tags_new'), ('djangocms_blog', '0010_auto_20150923_1151'), ('djangocms_blog', '0011_auto_20151024_1809'), ('djangocms_blog', '0012_auto_20151220_1734'), ('djangocms_blog', '0013_auto_20160201_2235'), ('djangocms_blog', '0014_auto_20160215_1331'), ('djangocms_blog', '0015_auto_20160408_1849'), ('djangocms_blog', '0016_auto_20160502_1741'), ('djangocms_blog', '0017_thumbnail_move'), ('djangocms_blog', '0018_thumbnail_move2'), ('djangocms_blog', '0019_thumbnail_move3'), ('djangocms_blog', '0020_thumbnail_move4'), ('djangocms_blog', '0021_post_liveblog'), ('djangocms_blog', '0022_auto_20160605_2305'), ('djangocms_blog', '0023_auto_20160626_1539'), ('djangocms_blog', '0024_auto_20160706_1524'), ('djangocms_blog', '0025_auto_20160803_0858'), ('djangocms_blog', '0021_auto_20160823_2008'), ('djangocms_blog', '0026_merge'), ('djangocms_blog', '0027_post_date_featured'), ('djangocms_blog', '0028_auto_20170304_1040'), ('djangocms_blog', '0029_post_related'), ('djangocms_blog', '0030_auto_20170509_1831'), ('djangocms_blog', '0031_auto_20170610_1744'), ('djangocms_blog', '0032_auto_20180109_0023'), ('djangocms_blog', '0033_auto_20180226_1410'), ('djangocms_blog', '0022_auto_20170304_1040'), ('djangocms_blog', '0034_merge'), ('djangocms_blog', '0035_posttranslation_subtitle'), ('djangocms_blog', '0036_auto_20180913_1809'), ('djangocms_blog', '0037_auto_20190806_0743'), ('djangocms_blog', '0038_post_media'), ('djangocms_blog', '0039_auto_20200331_2227'), ('djangocms_blog', '0040_post_include_in_rss'), ('djangocms_blog', '0040_auto_20211128_1503'), ('djangocms_blog', '0041_auto_20211214_1137'), ('djangocms_blog', '0042_alter_post_enable_comments'), ('djangocms_blog', '0043_postcontent'), ('djangocms_blog', '0044_copy_plugins'), ('djangocms_blog', '0045_auto_20230314_0747'), ('djangocms_blog', '0046_auto_20230717_2307'), ('djangocms_blog', '0047_migrate_config')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paginate_by', models.SmallIntegerField(default=10, help_text='When paginating list views, how many articles per page?', null=True, verbose_name='Paginate size')),
                ...
                ('template_prefix', models.CharField(blank=True, default='', help_text='Alternative directory to load the blog templates from', max_length=200, verbose_name='Template prefix')),
                ...
                ('urlconf', models.CharField(choices=[('djangocms_blog.urls', 'Blog: Blog list at root url of blog'), ('djangocms_blog.urls_hub', 'Content hub: Category list at root url of blog')], default='djangocms_blog.urls', max_length=200, verbose_name='URL config')),
                ...
                ('use_related', models.SmallIntegerField(choices=[(0, 'No'), (1, 'Yes, from this blog config'), (2, 'Yes, from this site')], default=1, verbose_name='Enable related posts')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='djangocms_blog.blogcategory', verbose_name='parent')),
                ('app_config', models.ForeignKey(help_text='When selecting a value, the form is reloaded to get the updated default', null=True, on_delete=django.db.models.deletion.CASCADE, to='djangocms_blog.blogconfig', verbose_name='app. config')),
            ...
            options={
                ...
                'ordering': (django.db.models.expressions.OrderBy(django.db.models.expressions.F('priority'), nulls_last=True),),
            },
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('tags', taggit_autosuggest.managers.TaggableManager(blank=True, help_text='Type a tag and hit tab, or start typing and select from autocomplete list.', related_name='djangocms_blog_tags', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ...
            options={
                'ordering': (django.db.models.expressions.OrderBy(django.db.models.expressions.F('pinned'), nulls_last=True), '-date_published', '-date_created'),
        ...
        migrations.CreateModel(
            ...
            options={
                'get_latest_by': 'date_published',
                'ordering': (django.db.models.expressions.OrderBy(django.db.models.expressions.F('post__pinned'), nulls_last=True), '-post__date_published', '-post__date_created'),
